...
namespace isilani.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsKategoriId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IsIlanlari", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IsIlanlari_IsKategoriler_IsKategoriId",
                        column: x => x.IsKategoriId,
                        principalTable: "IsKategoriler",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IsIlanlari_IsKategoriId",
                table: "IsIlanlari",
                column: "IsKategoriId");
        }
